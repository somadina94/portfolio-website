      ...
      <div className="flex flex-col gap-4 mb-8  md:w-1/2">
        <div className="flex flex-col gap-4 ">
          <p className="text-muted-foreground mb-12 md:mb-0">
            ...
            React Native, and I’m experienced with backend technologies such as
            Firebase, Supabase, and Node.js. I enjoy turning complex problems
            into elegant solutions and constantly learning new tools to stay
            ahead in the ever-evolving tech space. Whether it&apos;s building
            intuitive UIs, integrating third-party APIs, or crafting robust
            backend logic, I strive to deliver high-quality, maintainable code
            that adds real value. When I&apos;m not coding, I&apos;m usually
            exploring new tech trends, collaborating on freelance projects, or
            refining products that make everyday tasks simpler and smarter.
          </p>
          <Link
            href="/about"
